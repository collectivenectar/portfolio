...
import {
  type InputPositionStore,
  createInputPositionStore,
} from "../stores/inputPositionStore";

export const InputPositionStoreContext =
  createContext<StoreApi<InputPositionStore> | null>(null);
...
export const useInputPositionStore = <T,>(
  ...
  if (!inputPositionStoreContext) {
    throw new Error(
      `useInputPositionStore must be used within useInputPositionStoreProvider`
    );
  }
