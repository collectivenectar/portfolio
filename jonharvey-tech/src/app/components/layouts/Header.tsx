const Header = () => {
    return (
      <header>
      <nav className="relative w-11/12 h-16 flex flex-row justify-between m-4 mx-auto rounded-full text-white border border-white">
        <a className="w-12 h-12 my-auto mx-2 rounded-full" href="/">
