...
const Footer = () => {
  return (
      ...
      <div>
        ...
        <ul className="flex flex-col lg:flex-row lg:flex-wrap lg:w-1/4 lg:justify-around lg:mx-auto lg:w-full h-fit w-full items-center">
          <li className="border border-transparent w-32 rounded-full py-2 my-2 h-fit transition duration-500 hover:bg-white hover:text-black">
            <a href="https://linkedin.com/in/jonharveydev" className="block">LinkedIn</a>
          </li>
          <li className="border border-transparent w-32 rounded-full py-2 my-2 h-fit transition duration-500 hover:bg-white hover:text-black">
            <a href="https://github.com/collectivenectar" className="block">Github</a>
          </li>
          <li className="border border-transparent w-32 rounded-full py-2 my-2 h-fit transition duration-500 hover:bg-white hover:text-black">
            <a href="https://x.com/_jonharvey" className="block">X/Twitter</a>
          </li>
          {/* <li className="border border-transparent w-32 rounded-full py-2 my-2 h-fit transition duration-500 hover:bg-white hover:text-black">
    ...
    <p className="mt-4">© 2024 Jon Harvey. All rights reserved.</p>
  </footer>
